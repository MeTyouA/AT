...
#include "rmoss_gz_base_lu_version26/chassis_controller.hpp"
#include "rmoss_gz_base_lu_version26/gimbal_controller.hpp"
#include "rmoss_gz_base_lu_version26/gz_chassis_actuator.hpp"
#include "rmoss_gz_base_lu_version26/gz_gimbal_actuator.hpp"
#include "rmoss_gz_base_lu_version26/gz_gimbal_encoder.hpp"
#include "rmoss_gz_base_lu_version26/gz_gimbal_imu.hpp"
#include "rmoss_gz_base_lu_version26/gz_light_bar_cmd.hpp"
#include "rmoss_gz_base_lu_version26/gz_odometry.hpp"
#include "rmoss_gz_base_lu_version26/gz_shoot_actuator.hpp"
#include "rmoss_gz_base_lu_version26/odometry_publisher.hpp"
#include "rmoss_gz_base_lu_version26/pid.hpp"
#include "rmoss_gz_base_lu_version26/shooter_controller.hpp"
...
private:
    ...
    std::shared_ptr<rmoss_gz_base::IgnGimbalActuator> gimbal_yaw_vel_actuator_;
    ...
    std::shared_ptr<rmoss_gz_base::IgnGimbalEncoder> gz_gimbal_yaw_encoder_;
    std::shared_ptr<rmoss_gz_base::IgnGimbalImu> gz_gimbal_big_imu_;
    std::shared_ptr<rmoss_gz_base::IgnGimbalImu> gz_gimbal_pitch_imu_;
    ...
    std::shared_ptr<rmoss_gz_base::GimbalController> gimbal_yaw_controller_;
