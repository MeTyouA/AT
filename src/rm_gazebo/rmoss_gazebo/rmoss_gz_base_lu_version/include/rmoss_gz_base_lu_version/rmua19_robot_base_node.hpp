...
#include "rmoss_gz_base_lu_version/gz_chassis_actuator.hpp"
#include "rmoss_gz_base_lu_version/gz_gimbal_actuator.hpp"
#include "rmoss_gz_base_lu_version/gz_shoot_actuator.hpp"
#include "rmoss_gz_base_lu_version/gz_gimbal_imu.hpp"
#include "rmoss_gz_base_lu_version/gz_gimbal_encoder.hpp"
#include "rmoss_gz_base_lu_version/gz_odometry.hpp"
#include "rmoss_gz_base_lu_version/gz_light_bar_cmd.hpp"
#include "rmoss_gz_base_lu_version/chassis_controller.hpp"
#include "rmoss_gz_base_lu_version/gimbal_controller.hpp"
#include "rmoss_gz_base_lu_version/shooter_controller.hpp"
#include "rmoss_gz_base_lu_version/odometry_publisher.hpp"
#include "rmoss_interfaces/msg/robot_status.hpp"
#include "std_msgs/msg/bool.hpp"
#include "rmoss_gz_base_lu_version/pid.hpp"
...
private:
  ...
  std::shared_ptr<rmoss_gz_base::IgnGimbalActuator> gimbal_big_vel_actuator_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalActuator> gimbal_right_vel_actuator_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalActuator> gimbal_left_vel_actuator_;
  ...
  std::shared_ptr<rmoss_gz_base::IgnGimbalEncoder> gz_gimbal_big_encoder_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalEncoder> gz_gimbal_right_encoder_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalEncoder> gz_gimbal_left_encoder_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalImu> gz_gimbal_big_imu_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalImu> gz_gimbal_right_imu_;
  std::shared_ptr<rmoss_gz_base::IgnGimbalImu> gz_gimbal_left_imu_;
  ...
  std::shared_ptr<rmoss_gz_base::GimbalController> gimbal_big_controller_;
  std::shared_ptr<rmoss_gz_base::GimbalController> gimbal_left_controller_;
  std::shared_ptr<rmoss_gz_base::GimbalController> gimbal_right_controller_;
